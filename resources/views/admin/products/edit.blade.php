                ...
                <form action="{{ route('admin.products.update', $product) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <input type="number" name="stock" value="{{ old('stock', $product->stock) }}" class=" bg-neutral-900 border-neutral-700 focus:border-accent focus:ring-accent rounded-none w-full py-2 px-3 text-neutral-200" required>
