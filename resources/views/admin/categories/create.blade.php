            ...
            <div class="bg-ink overflow-hidden  sm:rounded-none p-6 border border-neutral-800 max-w-2xl mx-auto">
                <form action="{{ route('admin.categories.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" class=" bg-neutral-900 border-neutral-700 focus:border-accent focus:ring-accent rounded-none w-full py-2 px-3 text-neutral-200" placeholder="Ví dụ: Mỹ phẩm, Váy nữ..." required>
                        @error('name')
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="description" rows="4" class=" bg-neutral-900 border-neutral-700 focus:border-accent focus:ring-accent rounded-none w-full py-2 px-3 text-neutral-200" placeholder="Nhập mô tả ngắn cho danh mục...">{{ old('description') }}</textarea>
                    </div>
