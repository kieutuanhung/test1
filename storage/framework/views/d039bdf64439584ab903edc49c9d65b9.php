            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-xl p-6 border border-pink-100 max-w-2xl mx-auto">
                <form action="<?php echo e(route('admin.categories.store')); ?>" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" value="<?php echo e(old('name')); ?>" class="shadow-sm border-pink-200 focus:border-pink-500 focus:ring-pink-500 rounded-lg w-full py-2 px-3 text-gray-700" placeholder="Ví dụ: Mỹ phẩm, Váy nữ..." required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="description" rows="4" class="shadow-sm border-pink-200 focus:border-pink-500 focus:ring-pink-500 rounded-lg w-full py-2 px-3 text-gray-700" placeholder="Nhập mô tả ngắn cho danh mục..."><?php echo e(old('description')); ?></textarea>
                    </div>
...
<?php endif; ?>
<?php /**PATH /home/kali/WebProject/shopping-website-laravel/resources/views/admin/categories/create.blade.php ENDPATH**/ ?>